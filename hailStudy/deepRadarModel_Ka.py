...
fh=Dataset("zKaPrecip_Dataset.nc","r")
zKu=fh["zKu"][:]
t2c=fh["t2c"][:]
pRate=fh["pRate"][:]
fh.close()
...
X_val_IPHEX,y_IPHEX=getData("zKaPrecip_Dataset_Validation_IPHEX.nc",scalerZ,scalerT,scalerR)
X_val_ColStorm,y_ColStorm=getData("zKaPrecip_Dataset_Validation_ColStorm.nc",scalerZ,scalerT,scalerR)
