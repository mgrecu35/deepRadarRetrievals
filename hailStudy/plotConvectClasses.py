...
d=pickle.load(open("convProf.pklz","rb"))
...
c=plt.colorbar()
c.ax.set_title('dBZ')
plt.savefig('class_zKu_dist.png')
...
c=plt.colorbar()
c.ax.set_title('dBZ')
plt.savefig('class_zKa_dist.png')

plt.figure()
f=plt.subplot(211)
plt.plot(range(n1),pRateClass)
plt.title("Mean surface precipitation")
plt.ylabel("[mm/h]")
...
plt.xlabel("Class #")
plt.title("Percentage of profiles")
plt.ylabel("[%]")
plt.grid()
plt.xlim(0,49)
plt.savefig('classStats.png')
#plt.figure()
