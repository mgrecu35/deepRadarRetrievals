...
pRate3L=[]
it=1
processWRF(fname,it,itmax,bh,rhow,rhos,f_mu,gam,dm_lwc,mu,wl,refr_ind_s,refr_ind_w,zdb3,sfcRainRate3L,\
...
fname="zKaPrecip_Dataset_Validation_IPHEX.nc"
writeDset(zdb2,t2L,pia2L,sfcRainRate2L,pRate2L,fname)
fname="zKaPrecip_Dataset_Validation_ColStorm.nc"
