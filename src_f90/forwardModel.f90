...
subroutine reflectivity_ka(rwc1,swc1,wv1,dn1,temp,press,dr,nz,zka_m,&
...
subroutine reflectivity_ku(rwc1,swc1,wv1,dn1,temp,press,dr,nz,zku_m,&
  ...
  do k=nz,1,-1
     ...
     if(rwc1(k)>1e-2) then
        ...
        call bisection2(rwc(1:289),289,0.9*rwc1(k),ibin2)
        !print*, rwc1(k),ibin,ibin2
        attkur_11=attkur(ibin2)
        salbr11 = salbTable(ibin2,4,1)
        asymr11 = asymTable(ibin2,4,1)
        kextr11 = attkur_11/4.343
        kextt1 = kextt1 + kextr11
        salbt1 = salbt1 + kextr11*salbr11
        asymt1 = asymt1 + kextr11*salbr11*asymr11
        !print*, kextt1, kextt, kextr1,kextr11
...
subroutine reflectivity_ku_c(rwc1,swc1,wv1,dn1,temp,press,dr,nz,zku_m,&
     zku_out,attku_out, piaku, kext, salb, asym, kext1, salb1, asym1, pRate)
  use tablep2
  use tables2
  implicit none
  ...
  !  print*, piaKuAtm
  !stop
end subroutine reflectivity_ku_c
